...
namespace Serialization
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Serialize<Customer[]>(customers, "customer.array.xml");
            Serialize<IEnumerable<Customer>>(customers, "customer.ienumerable.xml");
            Serialize<IList<Customer>>(customers, "customer.list.xml");
        }
    }
}
